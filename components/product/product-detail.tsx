                  ...
                  <button
                    ...
                    className={
                      selectedSize?.key === w.key
                        ? "min-w-[30%] flex-1 rounded-lg border border-primary bg-primary/10 px-2 py-2.5 text-sm font-semibold text-primary"
                        : "min-w-[30%] flex-1 rounded-lg border border-border/60 bg-muted/20 px-2 py-2.5 text-sm text-muted-foreground hover:border-primary/40"
                    }
                  >
